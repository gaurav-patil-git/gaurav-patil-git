...
2. [_Fraud Claim_Prediction Model_](https://github.com/gaurav-patil-git/06_Fraud_Claim_Prediction_Model)
...
3. [_AI_for_Dashboard_Mockup_](https://github.com/gaurav-patil-git/05_Dashboard_Mockup)
